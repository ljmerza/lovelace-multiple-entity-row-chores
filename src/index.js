...
console.info(
    '%c MULTIPLE-ENTITY-ROW-CHORES %c 10.1.1 ',
    'color: cyan; background: black; font-weight: bold;',
    'color: darkblue; background: white; font-weight: bold;'
);

class MultipleEntityRowChores extends LitElement {
    ...
    set hass(hass) {
        ...
        if (hass && this.config) {
            ...
            const second_id = this.config.entity
...
customElements.define('multiple-entity-row-chores', MultipleEntityRowChores);
